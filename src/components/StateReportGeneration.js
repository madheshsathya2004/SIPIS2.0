...
const StateReportGeneration = ({ year }) => {
      ...
      if (year === '1991') {
        if (selection === 'Total') {
          ...
          if (level === 'District_Rural') {
            ...
            path = `/Report/1991/State/Rural/Villages.csv`;
          }
        }
      } else {
  ...
  return (
    <div className="form-group">
      <label htmlFor="selection">Select a Level</label>
      ...
      {filteredData && (
        <div className="mt-4">
          <h3>State Data</h3>
          <QueryComponent applyFilters={applyQueryFilters} revertFeatures={revertFeatures} year={year} />
          <input
            type="text"
